...
resource "aws_db_instance" "vprofile-rds" {
  ...
  db_subnet_group_name   = aws_db_subnet_group.vprofile-rds-subgrp.name //name attribute used for name of subnet group
...
resource "aws_mq_broker" "vprofile-rmq" {
  ...
  security_groups    = [aws_security_group.vprofile-backend-sg.id] //it is the name of backend security group
